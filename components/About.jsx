...
const About = () => {
  return (
    <div className="mx-auto mt-5 md:mx-[3rem] px-4 py-3 text-[#F9F9F9]" id='about-us'>
      <h1 className="text-4xl text-center font-bold mb-4 md:text-[64px]">About us</h1>
      ...
      <div className="mb-8 md:text-[20px]">
        ...
        <p className="mb-4">We are driven by a commitment to excellence and an unwavering belief in charting unconventional paths to deliver real, unmatched value to our clients. This approach has earned us the trust and loyalty of our customers, leading to repeat business and long-lasting partnerships.</p>
