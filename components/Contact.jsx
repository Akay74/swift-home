...
const Contact = () => {
  ...
  return (
    <div>
      <div className="container md:hidden mx-auto px-4 py-8" id='contact-us'>
        <h1 className="text-3xl font-bold text-[#F9F9F9] mb-2 text-center sm:text-4xl">Contact Us</h1>
